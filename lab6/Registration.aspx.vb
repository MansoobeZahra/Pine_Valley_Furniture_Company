...
Partial Class RegistrationPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ' Show Catalog link only to admin
    ...
    Protected Sub btnRegister_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Using conn As New SqlConnection(ConnStr)
            Try
                ...
                Dim sql As String = "INSERT INTO CUSTOMER_t (Customer_Id, Customer_Name, Customer_Address, Customer_City, Customer_State, Postal_Code) " & _
