-- ============================================
-- QuizWiz Complete Database Script
-- This script creates the database, all tables,
...
CREATE TABLE QuestionsTable (
    ...
    CorrectOption     CHAR(1)       NULL,  -- Keeping for legacy/compatibility
    CorrectOptions    NVARCHAR(500) NULL,  -- New column for multiple/text answers
...
CREATE TABLE Answers (
    ...
    QuizID      INT           NOT NULL REFERENCES Quiz(QuizID),
    QuestionID  INT           NOT NULL REFERENCES QuestionsTable(QuestionID),
    QNo         INT           NOT NULL,   -- display order
    CorrectAns  NVARCHAR(500) NOT NULL,
    StudentAns  NVARCHAR(500) NULL,       -- NULL if not answered
...
('Chemistry'), ('General Knowledge'), ('English');
...
(1,'What is the time complexity of Binary Search?','O(n)','O(n²)','O(log n)','O(1)','C','C','Radio','Medium',2),
...
(2,'What is the value of 2¹⁰?','512','1024','2048','256','B','B','Radio','Easy',3),
(2, 'What is the square root of 225?', '13', '14', '15', '16', 'C', '15', 'Radio', 'Easy', 3),
(2, 'What is the value of Sin(90°)?', '0', '1', '0.5', '-1', 'B', '1', 'Radio', 'Easy', 3);
...
PRINT 'Table Users renamed to Users2 and schema updated with all missing columns.';
GO
