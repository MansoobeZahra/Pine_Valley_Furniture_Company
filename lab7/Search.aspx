<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Search.aspx.vb" Inherits="SearchPage" %>
    ...
    <head runat="server">
        ...
        <style>
            ...
            .section-box { border: 1px solid #ccc; border-radius: 6px; padding: 16px 20px; margin: 0 0 24px; background: #fff; }
            .section-title { font-size: 15px; font-weight: bold; color: #583937; margin-bottom: 10px; }
            .search-table td { padding: 4px 8px; vertical-align: middle; }
            .gv-orders th { background: #583937; color: white; padding: 7px 10px; text-align: left; }
            .gv-orders td { padding: 6px 10px; border-bottom: 1px solid #eee; }
            .gv-orders tr:nth-child(even) td { background: #fafafa; }
            .gv-orders tr:hover td { background: #fff3e0; }
            .grand-total { font-weight: bold; color: #583937; font-size: 14px; margin-top: 8px; text-align: right; }
            .order-summary { background: #fff8e1; border-left: 4px solid #583937; padding: 8px 14px; margin-top: 10px; font-size: 13px; }
            select { padding: 4px 8px; border: 1px solid #ccc; border-radius: 3px; min-width: 220px; }
            input[type=text] { padding: 4px 8px; border: 1px solid #ccc; border-radius: 3px; }
        </style>
    </head>
                    ...
                    <table class="search-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="font-size:11px;color:#999;margin-left:6px;">(shows name → searches by ID)</span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:Panel ID="pnlOrderResults" runat="server" Visible="false">
                        ...
                        <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Ordered_Quantity"     HeaderText="Qty"           ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="Unit_Price"           HeaderText="Unit Price"    DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right" />
                                <asp:BoundField DataField="Line_Total"           HeaderText="Line Total"    DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right" />
                            </Columns>
                        </asp:GridView>
                        <div class="grand-total">
                            Grand Total: <asp:Label ID="lblOrderGrandTotal" runat="server" />
                        </div>
                    </asp:Panel>
                </div>
